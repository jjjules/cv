...
% CONTACT INFORMATION
%====================
\def\name{Jules Gottraux} % Name Here
\def\phone{(+41) 078 647 40 91}
\def\street{Rue de la Borde 29}
\def\city{CH-1018 Lausanne\\ Vaud, Switzerland}
\def\email{jules.gottraux@gmail.com}
\def\LinkedIn{julesgottraux} % linkedin.com/in/______
\def\github{jjjules} % github username
\def\role{ } % JOB TITLE
